    ...
    if (Platform.OS === 'android') {
      if (!isBubbleEnabled) {
        ...
        try {
          ...
          if (hasPermission) {
            ...
            if (started) {
              Alert.alert(
                'Bubble Started!',
                'Bubble ab screen par dikh raha hai. App minimize karke WhatsApp open karo.\n\n• Message copy karne par half ring fill hogi\n• Scan button se GPS capture hoga\n• Bubble ko drag karke move kar sakte ho\n• Long press karke band kar sakte ho',
                [{ text: 'OK' }]
              );
            }
          } else {
          ...
          setIsCheckingPermission(false);
          console.log('[v0] Native module error:', error);
          
          // Native module not available
          Alert.alert(
            'Build Required',
            'System overlay ke liye app ko rebuild karna padega:\n\n1. Terminal me jao\n2. Run: npx expo prebuild --clean\n3. Run: npx expo run:android\n\nYe native Android code add karega jo bubble ko app ke bahar dikhayega.',
            [{ text: 'OK' }]
          );
        }
      } else {
        ...
        try {
          ...
          console.log('[v0] Stop overlay error:', e);
        }
        Alert.alert('Bubble Stopped', 'Bubble band ho gaya hai.');
      }
    } else {
      Alert.alert('Android Only', 'Ye feature sirf Android me kaam karta hai.');
    }
  };
